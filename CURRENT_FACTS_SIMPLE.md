...
`0.18.1` 为当前发布候选，尚未公开发布。候选已合入 Proma `v0.19.57` 与 Pi `0.86.1`，并继续完成三模式界面和会话/右侧工作区状态修复。定向状态回归与隔离打包界面检查已有通过证据；完整回归、最终提交、CI、签名资产及更新元数据仍待收口。日用安装未替换。详见 [0.18.1 候选验证](./docs/release/VALIDATION_0_18_1.md)。
