...
- 当前交付分支：`main`。
- Proma 基线：`v0.19.23@1ab22a17effd344c3f376538318efbf1628150ea`。
- LA 起点：`f95e1880b75a0c1dcfd090f3e48303fdbd7bb4d2`。
- 正式 merge：`8ff00976ea91b83242f4c46a66d70d4dae129bac`。
...
|---|---|
| Bun | `1.3.14` |
| Electron App / Electron | `0.17.68` / `43.2.0` |
...
- 本轮一次 merge Proma v0.19.23；会话拖入输入框引用、单一委派观察 Tab、Vault 折叠侧栏及 Markdown / Preview / Changes 修复直接继承上游。
...
- v0.19.23 Proma Core ledger 为 `229` 个生产触点：Product Fork `217`、Generated `2`、Host Seam `8`、Temporary Deviation `2`。
...
- 全仓 typecheck 通过；默认 CI 关键回归 `355/355` 通过。
