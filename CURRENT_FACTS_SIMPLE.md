...
Proma 稳定基线为 `v0.19.37`，正式合并 `4a7cbcec`。LA `0.17.72` 已于 2026-09-08 发布，Tag 指向 `1136b426`；最终 CI `34182752848` 与自动发布 `34183280354` 成功。已下载核验六步报告、Dock 专项、正式 arm64 ZIP 签名及更新索引 SHA-512；两次先前失败及滚动条修正见 [发布验证](./docs/release/VALIDATION_0_17_72.md)。本机安装版由用户通过自动更新升级，尚未确认用户完成安装。
