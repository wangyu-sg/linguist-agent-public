...
当前是作者本人使用的 **个人 Alpha**，没有公众发布计划。稳定基线是 Proma `v0.17.26@db94285a`；Electron App `0.17.34`、Electron `43.2.0`、`@proma/shared 0.1.98`、Pi `0.82.1`、CAT Core / Formats / Store / Tools `0.0.21 / 0.0.11 / 0.0.39 / 0.0.34`、CAT schema `16`，仓库使用 Bun `1.3.14`。
