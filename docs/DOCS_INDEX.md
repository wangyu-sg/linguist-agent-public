...
- [0.18.1 实施与发布验证](./release/VALIDATION_0_18_1.md) — 已公开发布，CI 与 Release 工作流成功；正式资产哈希、签名及更新配置已核验，日用正式包启动与检查更新通过。

- [0.18 实施与发布验证](./release/VALIDATION_0_18_0.md) — 前一版本历史证据；[实施起点](./release/LA018_BASELINE.md)记录本轮基线与证据边界。

- [0.17.75 实施与发布验证](./release/VALIDATION_0_17_75.md) — 浏览器操作、原生 UI 共用与定时任务领域快照。

- [Proma 上游更新与发布](./release/UPSTREAM_0_19_53_2026_09_14.md) — 固定 Tag 合并、Pi 升级、打包验证和发布证据。
