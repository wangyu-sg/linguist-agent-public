...
- 当前版本：Electron App `0.16.33`、Shared `0.1.91`、CAT Core / Formats / Store / Tools `0.0.19 / 0.0.10 / 0.0.34 / 0.0.31`、schema `15`。
...
- Workbook Mapping 可预览建议并持久化复用；Voice Profile 与 approved exemplar 可结构化写入并按需返回给 Agent。
...
- 本轮测试：根 `1514/1514`（`6758` assertions）、Electron Linguist `181/181`、CAT Core `100/100`、CAT Formats `163/163`、CAT Store `228/228`、CAT Tools `40/40`、boundary `4/4`、fusion architecture `9/9`。
