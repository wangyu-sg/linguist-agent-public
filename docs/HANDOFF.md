...
本轮执行 2026-09-06 新优化方案，起点为 `ddc6661c`；按工作流本地提交，不推送、打 Tag、Release 或替换安装版。当前版本和实现只在 [当前事实](../CURRENT_FACTS_SIMPLE.md) 维护。
...
本轮未执行真实收费 Provider、人工语言质量、Native Open/Save、IME/VoiceOver、目标平台安装和发布动作；这些资格继续保持未验证。不要搜集用户凭据或用客户文件替代 fixture。README / AGENTS 的必要修订仍未修改。
