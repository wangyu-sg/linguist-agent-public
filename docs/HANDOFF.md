...
本轮未执行真实收费 Provider、人工语言质量、Native Open/Save、IME/VoiceOver、目标平台安装和本机安装替换；这些资格继续保持未验证。在线更新 Release 已公开，平台发布已完成；此前 CI 打包验证空跑，修复后的真实验证结果见本轮实施记录。不要搜集用户凭据或用客户文件替代 fixture。README / AGENTS 的必要修订仍未修改。
