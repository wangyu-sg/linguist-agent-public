...
| 范围 | 状态 | 当前证据 |
|---|---|---|
| Proma v0.19.23 基线 | DONE | `1ab22a17` 已由 `8ff00976` 一次 merge；三模式、独立数据根和 CAT authority 保留。 |
...
| 版本、基线与文档 | DONE | App `0.17.68`、Shared `0.1.68`；baseline / ledger / canonical facts 已同步。 |
...
- 全仓 typecheck；默认 CI 关键回归 `355/355`；boundary `4/4`；fusion `14/14`；Host Seam `9/9`；历史冲突分类 `9/9`。
- v0.19.23 生产 ledger `229`：Product Fork `217`、Generated `2`、Host Seam `8`、Temporary Deviation `2`。
