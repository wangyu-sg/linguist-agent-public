# Proma Core Touchpoints — v0.19.53

> 基线：`v0.19.53@f99edbdb594407ab190b97ae073889c5d96637ab`
> 正式 merge：`56bc3f29b225c71f02f42483e10f1db8c3fcb2d5`
> 机读真源：[proma-touchpoints.json](./proma-touchpoints.json)

| 集合 | 路径数 |
|---|---:|
| Permanent Product Fork | 229 |
| Generated / Overlay | 2 |
| Main Host Seam | 8 |
...
4. Main Host Seam 保留 Agent Extension、IPC、Preload、Collaboration 与跨 utility 恢复/请求观察；Collaboration 的同一 hook 跨委派工具与 Pi builtin 传递可信 Context。Renderer Host Seam 只保留 AgentView、AppShell 和右侧工作区扩展三处；临时偏差包括 Pi compaction 与待上游化的通用修复，逐项退役条件以 JSON 为准。
