# Proma Core Touchpoints — v0.19.1

> 基线：`v0.19.1@3f1725c5b2e46c6aa85d64c175870c1fcb3bb5ed`
> 正式 merge：`8819a4a0990dfedffb691bf1e5cc04cc78a0d6d5`
> 机读真源：[proma-touchpoints.json](./proma-touchpoints.json)

| 集合 | 路径数 |
|---|---:|
| Permanent Product Fork | 196 |
| Generated / Overlay | 2 |
| Main Host Seam | 5 |
| Renderer Host Seam | 2 |
...
4. Main Host Seam 仅保留 Agent Extension、IPC、Preload 与 Collaboration；Collaboration 的同一 hook 跨委派工具与 Pi builtin 传递可信 Context。Renderer Host Seam 仅保留 AgentView 与 AppShell 两处；Pi compaction continuation context 是唯一 Temporary Deviation。
