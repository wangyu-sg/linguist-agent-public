...
import type { McpOAuthConfiguration, McpOAuthProvider, McpOAuthStartResult, SaveMcpApiKeyInput, StartMcpOAuthInput } from '@proma/shared'
...
export function saveMcpApiKey(input: SaveMcpApiKeyInput): void {
