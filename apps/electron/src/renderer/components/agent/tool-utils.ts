...
const TOOL_DISPLAY_NAMES: Record<string, string> = {
  ...
  cat_list_assets: '查看批次',
  cat_list_batches: '查看批次',
  cat_get_segments: '读取项目片段',
  cat_get_translation_context: '读取翻译上下文',
  cat_search_tm: '查找翻译记忆',
  cat_search_terms: '搜索项目术语',
  cat_search_sentence_patterns: '搜索句式库',
  cat_read_context_doc: '读取上下文文档',
  cat_propose_translations: '创建翻译建议',
  cat_accept_proposals: '写回译文',
  cat_get_proposal_snapshot: '查看建议快照',
  cat_import_resources: '导入批次与资料',
  cat_import_asset: '导入文件',
  cat_export_asset: '导出批次',
  cat_export_batch: '导出批次',
  cat_scan_unknown_tag_patterns: '扫描未知 Tag',
  cat_save_tag_profile_candidate: '保存 Tag 候选',
  cat_run_qa: '运行项目质检',
