...
export function WeChatSettings(): React.ReactElement {
  ...
  return (
    <div className="space-y-8">
      ...
      <SettingsSection
        title="微信集成"
        description="扫码登录微信，在微信中控制 Linguist Agent"
      >
        <SettingsCard>
          ...
          <div className="px-4 py-4 space-y-5 text-sm">
            ...
            <div className="space-y-1.5">
              ...
              <p className="pl-7 text-muted-foreground">
                点击上方「扫码登录」，用微信扫描二维码。
                这会将你的微信账号作为 Bot 接入 Linguist Agent。
              </p>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <p className="pl-7 text-muted-foreground">
                扫码成功后，Linguist Agent 会自动建立长连接。
                凭证会加密保存，下次启动 Linguist Agent 时自动重连。
              </p>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <p className="pl-7 text-muted-foreground">
                连接成功后，通过微信发送消息即可与 Linguist Agent 交互。
                支持文本、图片、文件等消息类型。
              </p>
            </div>
