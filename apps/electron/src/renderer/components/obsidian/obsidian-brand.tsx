...
/** Obsidian mark from Simple Icons (CC0-1.0), rendered with the active theme color. */
export function ObsidianIcon({ size = 24, ...props }: ObsidianIconProps): React.ReactElement {
