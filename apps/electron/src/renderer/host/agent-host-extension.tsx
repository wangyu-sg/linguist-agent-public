...
import { buildProjectComposerContextChips } from '@/features/linguist/projects/ProjectAgentRail'
import {
...
export interface AgentHostExtension {
  ...
  /** 绑定项目的 mutation revision;普通会话为 0。 */
...
export function useAgentHostExtension(
  ...
  const mutationVersion = useAtomValue(linguistProjectMutationStateAtomFamily(projectKey)).lastRevision
